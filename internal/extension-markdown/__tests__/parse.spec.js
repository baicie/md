...
describe('parse', () => {
  describe('marks', () => {
    ...
    describe('link', () => {
      ...
      test('html', () => {
        expect(
          parse('<a href="http://example.org">example</a>'),
        ).toMatchSnapshot()
      })
    })
  })
  describe('nodes', () => {
    ...
    describe('bullet list', () => {
      ...
      test('html', () => {
        expect(
          parse('<ul><li>example1</li><li>example2</li></ul>'),
        ).toMatchSnapshot()
      })
    })
    describe('ordered list', () => {
      ...
      test('html', () => {
        expect(
          parse('<ol><li>example1</li><li>example2</li></ol>'),
        ).toMatchSnapshot()
      })
    })
    describe('fence', () => {
    ...
    describe('image', () => {
      ...
      test('markdown inline', () => {
        expect(
          parse('![example](example.jpg)', { image: { inline: true } }),
        ).toMatchSnapshot()
      })
      test('html', () => {
    ...
    describe('hard break', () => {
      ...
      test('markdown with breaks option + inline', () => {
        expect(
          parse('example1\nexample2', { breaks: true, inline: true }),
        ).toMatchSnapshot()
      })
      test('html', () => {
    ...
    describe('html', () => {
      test('block', () => {
        expect(
          parse('<custom-element>example</custom-element>', {
            htmlNode: {
              group: 'block',
              content: 'inline*',
              parseHTML: () => [
      ...
      test('inline', () => {
        expect(
          parse('<custom-element></custom-element>', {
            htmlNode: {
              group: 'inline',
              inline: true,
              parseHTML: () => [
