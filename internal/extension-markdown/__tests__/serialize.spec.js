...
import { dedent, serialize } from './utils'
...
describe('serialize', () => {
  describe('marks', () => {
    ...
    test('link', () => {
      expect(serialize('<a href="http://example.org">example</a>')).toEqual(
  ...
  describe('nodes', () => {
    ...
    test('bullet list', () => {
      expect(serialize('<ul><li>example1</li><li>example2</li></ul>')).toEqual(
        '- example1\n- example2',
      )
    ...
    test('ordered list', () => {
      expect(serialize('<ol><li>example1</li><li>example2</li></ol>')).toEqual(
        '1. example1\n2. example2',
      )
      expect(
        serialize('<ol start="10"><li>example1</li><li>example2</li></ol>'),
      ).toEqual('10. example1\n11. example2')
    })
